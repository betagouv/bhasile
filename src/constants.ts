...
export const DOCUMENTS_FINANCIERS_OPEN_YEAR = Number(
  process.env.NEXT_PUBLIC_DOCUMENTS_FINANCIERS_OPEN_YEAR
);

export const INDICATEUR_FINANCIER_CUTOFF_YEAR = Number(
  process.env.NEXT_PUBLIC_INDICATEUR_FINANCIER_CUTOFF_YEAR
);

export const AUTORISEE_OPEN_YEAR = Number(
  process.env.NEXT_PUBLIC_AUTORISEE_OPEN_YEAR
);
export const SUBVENTIONNEE_OPEN_YEAR = Number(
  process.env.NEXT_PUBLIC_SUBVENTIONNEE_OPEN_YEAR
);
