...
// Correspondance entre les colonnes de reporting.structures_global_quality  codes du registre.
// Le test interdit qu'un code soit ajouté sans être reporté dans la vue.
