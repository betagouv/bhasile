...
import { FieldSetAntennes } from "@/app/components/forms/adresseAdministrativeAndAntenne/FieldSetAntennes";
...
describe("FieldSetAntennes", () => {
  ...
  describe("Rendering", () => {
    it("renders nothing when isMultiAntenne is false", () => {
      render(
        <FormTestWrapper defaultValues={{ isMultiAntenne: false, antennes: [] }}>
          <FieldSetAntennes />
        </FormTestWrapper>
      );
