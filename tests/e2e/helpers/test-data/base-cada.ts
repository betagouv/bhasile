...
/**
 * Base CADA test data with all common fields
 * Use createCadaTestData() factory to create variations
 */
export const baseCadaData: Omit<TestStructureData, "dnaCode"> = {
  ...
  finalisationNotes: "Notes de finalisation dynamiques (CADA) : contrôle OK, suivi actif.",
};
