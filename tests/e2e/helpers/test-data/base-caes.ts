...
/**
 * Base CAES test data with all common fields
 * CAES is a subventionnée structure - requires convention dates, no FINESS, no periode autorisation
 */
export const baseCaesData: Omit<TestStructureData, "dnaCode"> = {
  ...
  finalisationNotes: "Notes de finalisation dynamiques (CAES) : contrôle OK, suivi actif.",
};
