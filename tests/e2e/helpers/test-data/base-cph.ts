...
/**
 * Base CPH test data with all common fields
 * CPH is an autorisée structure (like CADA) - requires FINESS and periode autorisation
 */
export const baseCphData: Omit<TestStructureData, "dnaCode"> = {
  ...
  finalisationNotes: "Notes de finalisation dynamiques (CPH) : contrôle OK, suivi actif.",
};
