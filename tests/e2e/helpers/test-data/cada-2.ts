...
export const cada2: TestStructureData = {
  dnaCode: "C1234",
  type: StructureType.CADA,
  cpom: false,
  operateur: {
    name: "Opérateur Test 2",
    searchTerm: "Opér",
  },
  ...
  structureTypologies: [
    ...
    {
      placesAutorisees: 148,
      pmr: 5,
      lgbt: 10,
      fvvTeh: 83,
    },
    {
      placesAutorisees: 145,
      pmr: 4,
      lgbt: 8,
      fvvTeh: 71,
    },
  ...
  finalisationNotes:
    "Notes de finalisation dynamiques (CADA 2) : contrôle OK, suivi actif.",
};
