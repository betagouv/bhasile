...
SELECT s."dnaCode" AS "dnaCode",
  ...
  COALESCE(
    fin."has_issue_taux_encadrement_min_lt_15",
    FALSE
  ) AS "has_issue_taux_encadrement_min_lt_15",
  ...
  COALESCE(
    fin."has_issue_authorized_excedent_affectations_mismatch",
    FALSE
  ) AS "has_issue_authorized_excedent_affectations_mismatch",
  COALESCE(
    fin."has_issue_authorized_negative_affectations",
    FALSE
