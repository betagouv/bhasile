...
-- AddForeignKey
ALTER TABLE "RoleDepartement"
ADD CONSTRAINT "RoleDepartement_departementId_fkey" FOREIGN KEY ("departementId") REFERENCES "Departement"("id") ON DELETE CASCADE ON UPDATE CASCADE;
-- AddForeignKey
ALTER TABLE "RoleDepartement"
ADD CONSTRAINT "RoleDepartement_roleId_fkey" FOREIGN KEY ("roleId") REFERENCES "Role"("id") ON DELETE CASCADE ON UPDATE CASCADE;
-- AddForeignKey
ALTER TABLE "EmailPattern"
ADD CONSTRAINT "EmailPattern_roleId_fkey" FOREIGN KEY ("roleId") REFERENCES "Role"("id") ON DELETE RESTRICT ON UPDATE CASCADE;
-- AddForeignKey
ALTER TABLE "User"
ADD CONSTRAINT "User_roleId_fkey" FOREIGN KEY ("roleId") REFERENCES "Role"("id") ON DELETE
SET NULL ON UPDATE CASCADE;
-- AddForeignKey
ALTER TABLE "User"
ADD CONSTRAINT "User_emailPatternId_fkey" FOREIGN KEY ("emailPatternId") REFERENCES "EmailPattern"("id") ON DELETE
SET NULL ON UPDATE CASCADE;