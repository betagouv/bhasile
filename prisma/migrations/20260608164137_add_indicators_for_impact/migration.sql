...
*/
-- AlterTable
ALTER TABLE "reporting"."MonthlyStructuresGlobalQualityCount" DROP COLUMN "has_issue_cout_journalier_max_gt_35",
...
-- CreateIndex
CREATE UNIQUE INDEX "TarifJournalierCible_structureType_isIdf_key" ON "reporting"."TarifJournalierCible"("structureType", "isIdf");
