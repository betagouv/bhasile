...
CREATE TABLE "reporting"."MonthlyReportingMetric" (
    ...
    CONSTRAINT "MonthlyReportingMetric_pkey" PRIMARY KEY ("month")
);

-- CreateTable
CREATE TABLE "reporting"."MonthlySupportContact" (
    "month" TIMESTAMP(3) NOT NULL,
    "contactsCount" INTEGER NOT NULL,
    "notes" TEXT,
    "createdAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updatedAt" TIMESTAMP(3) NOT NULL DEFAULT CURRENT_TIMESTAMP,

    CONSTRAINT "MonthlySupportContact_pkey" PRIMARY KEY ("month")
);
...
CREATE TABLE "reporting"."MonthlyStructuresGlobalQualityCount" (
    ...
    CONSTRAINT "MonthlyStructuresGlobalQualityCount_pkey" PRIMARY KEY ("month")
);
